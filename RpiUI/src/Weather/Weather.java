...
/**
 * @author chris used for receive and store the weather information.
 */
public class Weather {

    /**
     * Location location:	current location of the device Int hiTemp: highest
     * temperature of today Int lotemp: lowest temperature of today currentTemp:
     * current temperature of today Gson data: store the data for location
     * ForecaseIO fio: contain Forecast setting FIOCurrently current: current
     * weather information FIODaily daily: several days’ weather information
    ...
    /**
     * Keys in Current: summary percipProbability visibility percipIntensity
     * percipIntesityError icon cloudCover windBearing apparentTemperature
     * pressure dewPoint ozone nearestStormDistance percipType temperature
     * humidity time windSpeed
     */
    ...
    /**
     * Keys in Daily: apparentTemperatureMinTime apparentTemperatureMin
     * apparentTemperatureMaxTime apparentTemperatureMax cloudCover dewPoint
     * humidity icon moonPhase ozone precipIntensityMaxTime precipIntensityMax
     * precipIntensity precipType pressure temeratureMinTime temperatureMin
     * temperatureMaxTime temperatureMax summary sunriseTime sunsetTime time
