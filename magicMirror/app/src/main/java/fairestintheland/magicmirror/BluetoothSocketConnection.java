/*
NOT USED RIGHT NOW. ALL OF THIS FUNCTIONALITY HAS BEEN MOVED TO MAIN.
 */
...
public class BluetoothSocketConnection {
    ...
    public BluetoothSocketConnection(Context context) {
    ...
    public void setupBluetooth() {
        ...
        //filter = new IntentFilter(BluetoothDevice.ACTION_FOUND); //TODO moved to main DONE
        //registerReceiver(mReceiver, filter); // Don't forget to unregister during onDestroy//TODO moved to main DONE

        //bluetoothManager = (BluetoothManager) getSystemService(BLUETOOTH_SERVICE); //TODO moved to main DONE
    ...
    /**
     *  Gets the bytes that make up any data to be written to the raspberry app and writes them to
     *  the bluetooth socket. Also repeats the written data to Sys.out.
     *
     ...
     * //TODO whole method moved to main
     *
    ...
    protected void onDestroy() {
        ...
        //unregisterReceiver(mReceiver); //TODO moved to main
